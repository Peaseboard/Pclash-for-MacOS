...
class AppDelegate: FlutterAppDelegate {
  ...
  private func createMainMenu() -> NSMenu {
    ...
    editMenu.addItem(NSMenuItem(title: "撤销", action: #selector(NSResponder.undo(_:)), keyEquivalent: "z"))
    editMenu.addItem(NSMenuItem(title: "重做", action: #selector(NSResponder.redo(_:)), keyEquivalent: "Z"))
